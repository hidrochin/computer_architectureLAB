...
SEARCH_RESULT_RAW:	.space	600
SEARCH_RESULT:		.space	1000

FLAG_CASE_SENSITIVE:	.word	1
FLAG_CASE_INSENSITIVE:	.word	0
STRING_MAX_LENGTH:	.word	128

ASK_FIRST_STRING:	.asciiz	"First string?"
ASK_SECOND_STRING:	.asciiz	"Second string?"
ASK_SEARCH_MODE:		.asciiz	"Case sensitive searching?"

BUFFER_FIRST_STRING:	.space 129
BUFFER_SECOND_STRING:	.space 129
	
SEPARATOR:		.ascii ","

SEARCH_NOT_FOUND:	.asciiz	"String not found!!!"	
SEARCH_FOUND:		.asciiz	"String found at offsets: "
